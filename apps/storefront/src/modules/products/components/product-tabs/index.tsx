        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Twoja paczka dotrze w ciągu kilku dni roboczych do punktu odbioru albo bezpośrednio pod wskazany adres.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Rozmiar nie pasuje? Bez problemu wymienimy produkt na inny.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Zwróć produkt, a otrzymasz zwrot pieniędzy. Zadbamy o to, aby proces zwrotu był prosty i wygodny.
            </p>
          </div>
        </div>
      </div>
